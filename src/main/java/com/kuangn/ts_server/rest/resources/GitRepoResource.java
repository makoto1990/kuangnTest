...
public class GitRepoResource
{
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public String list(@QueryParam("pull") FancyBoolean fancyBoolean) throws JsonGenerationException, JsonMappingException, IOException, GitAPIException {
        ...
        String content = gitHelper.getTestCaseJsonString("\\testcase.json");
